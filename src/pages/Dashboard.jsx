...
export default function Dashboard() {
  return (
    <div id="dashboard-container">
      <PageHeader title="Dashboard" breadcrump="Dashboard / order List">
        <button
          id="add-button"
          className=" cursor-pointer bg-hijau text-white px-4 py-2 rounded-lg"
        >
          Add Button
        </button>
      </PageHeader>
      ...
      >
        ...
        >
          ...
          <div id="delivered-info" className="flex flex-col">
            <span id="delivered-count" className="text-2xl font-semibold">
              175
            </span>
        ...
        >
          ...
          <div id="canceled-info" className="flex flex-col">
            <span id="canceled-count" className="text-2xl font-semibold">
              40
            </span>
        ...
        >
          ...
          <div id="revenue-info" className="flex flex-col">
            <span id="revenue-amount" className="text-2xl font-semibold">
              Rp.128
            </span>
